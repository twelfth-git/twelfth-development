    ...
    return (
        <div className="border border-lines rounded-lg p-4 flex flex-col gap-4">
            ...
            <div className="flex gap-4">
                ...
                <div className="flex gap-2 items-center w-36 flex-grow bg-pdark rounded-lg justify-center py-2">
