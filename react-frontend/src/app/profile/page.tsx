// src/app/profile/page.tsx (ou onde quer que sua página esteja)
"use client";
...
// A interface PostType permanece a mesma
interface PostType {
  id: number;
...
export default function ProfilePage() {
  ...
  // A lógica de dados e filtragem permanece a mesma
  const allPosts: PostType[] = [
    ...
    { id: 2, type: "post", content: "Outro post qualquer" },
    { id: 3, type: "memory", component: "highlight" },
    { id: 4, type: "memory", content: "Uma memória legal" },
    { id: 5, type: "media", content: "Uma foto ou vídeo" },
  ];
          ...
          <div className="absolute -bottom-18 left-4 right-4 flex justify-between items-start">
            <div className="flex items-start gap-3">
              ...
              <div className="flex flex-col relative top-14">
                ...
                <p className="text-lines text-sm mt-1">
                  <span className="text-light cursor-pointer hover:underline">165 </span>
                  seguindo ·{" "}
                  <span className="text-light cursor-pointer hover:underline">1.9MI </span>{" "}
                  seguidores
                </p>
              </div>
            </div>
            <div className="flex flex-col items-end gap-2 mt-14">
              <div className="flex gap-2">
                <button className="relative bg-[linear-gradient(180deg,#060606_0%,#151515_100%)] p-2 rounded-lg cursor-pointer border border-lines hover:shadow-[0_0_20px_rgba(255,138,0,0.5)] transition-shadow duration-500">
                ...
                <button
                  ...
                  className="relative group bg-[linear-gradient(180deg,#060606_0%,#151515_100%)] p-2 rounded-lg cursor-pointer border border-lines overflow-hidden hover:shadow-[0_0_20px_rgba(255,138,0,0.5)] transition-all duration-500"
                >
                  <CheckFatIcon
                    size={22}
